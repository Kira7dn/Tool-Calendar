    ...
    sections: [
      {
        ...
        children: [
          ...
          new Paragraph({
            children: [
              new TextRun({
                text: `Thực hiện quy chế làm việc của Ủy ban nhân dân, UBND phường Cẩm Phả báo cáo tình hình tiếp nhận và xử lý văn bản đến của các cơ quan, đơn vị trực thuộc trong tháng ${month} năm ${year} cụ thể như sau:`,
                size: 28,
              }),
            ],
